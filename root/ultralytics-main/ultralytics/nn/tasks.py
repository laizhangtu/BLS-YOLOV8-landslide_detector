...
from ultralytics.nn.modules import (AIFI, C1, C2, C3, C3TR, OBB, SPP, SPPF, Bottleneck, BottleneckCSP, C2f, C3Ghost,
                                    ...
                                    RepConv, ResNetLayer, RTDETRDecoder, Segment,space_to_depth)
from ultralytics.nn.EMA import EMA
from ultralytics.nn.modules.bifb import BiFormerBlock
...
from .addmodules.SPPELAN import SPPELAN
from .modules.RCSOSA import RCSOSA
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in (Classify, Conv, ConvTranspose, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, Focus,
                 BottleneckCSP, C1, C2, C2f, C3, C3TR, C3Ghost, nn.ConvTranspose2d, DWConvTranspose2d, C3x, RepC3,SPPELAN,RCSOSA):
            c1, c2 = ch[f], args[0]
